...
COPY cc_detail
FROM 'C:\Users\Stephen John\Downloads\PowerBI\Credit_Card_Financial_Dashboard\credit_card.csv' 
DELIMITER ',' 
CSV HEADER;
...
COPY cust_detail
FROM 'C:\Users\Stephen John\Downloads\PowerBI\Credit_Card_Financial_Dashboard\customer.csv' 
DELIMITER ',' 
CSV HEADER;
...
COPY cc_detail
FROM 'C:\Users\Stephen John\Downloads\PowerBI\Credit_Card_Financial_Dashboard\cc_add.csv' 
DELIMITER ',' 
CSV HEADER;
...
COPY cust_detail
FROM 'C:\Users\Stephen John\Downloads\PowerBI\Credit_Card_Financial_Dashboard\cust_add.csv' 
DELIMITER ',' 
CSV HEADER;